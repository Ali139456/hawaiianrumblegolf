      ...
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:items-center">
        <Reveal className="order-2 lg:order-1" y={24}>
          ...
          <p className="mt-4 text-lg text-slate-300">
            Browse movie posters, Hollywood collectibles, one-of-a-kind finds, and retro candy, right
            here at Hawaiian Rumble, or visit{" "}
        ...
        <Reveal className="order-1 overflow-hidden rounded-3xl border border-white/10 shadow-2xl lg:order-2" delay={0.1} y={20}>
          <Image
            src={media.giftShop}
            alt="Texas Movie Shop collectibles at Hawaiian Rumble"
            width={1200}
            height={800}
