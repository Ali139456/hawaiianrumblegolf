  ...
  return (
    <section id="experience" className="scroll-mt-24 bg-white px-4 py-20 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <StaggerRoot className="mt-12 grid gap-6 md:grid-cols-3">
          {cards.map((c, i) => (
            <MotionItem key={c.title} lift index={i}>
              <article className="h-full rounded-3xl border border-slate-200 bg-surface p-8 shadow-sm transition-shadow hover:shadow-md">
