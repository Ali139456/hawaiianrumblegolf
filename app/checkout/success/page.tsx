      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 py-16">
        <div className="rounded-2xl border border-white/60 bg-surface-elevated/90 p-8 shadow-sm backdrop-blur-sm">
          ...
          <p className="mt-3 text-sm text-muted">
            Stripe reported a successful test checkout. This page does not verify the session on the
            server yet — add a webhook or retrieve the session when you go live.
          </p>
          {sessionId ? (
